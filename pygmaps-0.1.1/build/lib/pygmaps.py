...
class maps:
    ...
    def addradpoint(self, lat,lng,rad,color = '#0000FF'): #title=None
    ...
    def drawradpoints(self, f):
        for rpoint in self.radpoints:
            ...
            self.drawPolygon(f,path,strokeColor = rpoint[3],fillColor = rpoint[3]) #,rpoint[4]
...
#Circle? = "#0000FF",\
    def drawPolygon(self,f,path,strokeColor,fillColor, \
            clickable = False, \
            geodesic = True,\
            strokeOpacity = 0.8,\
            strokeWeight = 1,\
